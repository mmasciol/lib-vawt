...
class vawt_test(unittest.TestCase):
    def test_1_dynamic_stall(self):
        print self.test_1_dynamic_stall.__name__
        domain = libv()
        H = 5.0
        hubHt = 6.0
        D = 6.0
    ...
    def test_2_dynamic_stall(self):
        print self.test_2_dynamic_stall.__name__
        domain = libv()
        H = 5.0
        hubHt = 6.0
        D = 6.0
        ...
        plt.savefig('test_2_dynamic_stall.png', dpi=150)
        plt.show()
    ...
    def test_3_airfoil_extrapolate(self):
        print self.test_3_airfoil_extrapolate.__name__
        domain = libv()
        ...
        plt.savefig('test_3_airfoil_extrapolate.png', dpi=150)
        plt.show()
       
       
    def test_4_airfoil_blend(self):
        print self.test_4_airfoil_blend.__name__
        domain = libv()
        ...
        plt.savefig('test_4_airfoil_blend.png', dpi=150)
        plt.show()
       
        
    def test_5_plot_power(self):
        print self.test_5_plot_power.__name__
        domain = libv()
        H = 5.0
        hubHt = 6.0
        D = 6.0
        ...
        plt.savefig('test_5_plot_power.png', dpi=150)
        plt.show()
    ...
    def test_6_stationary_performance(self):
        print self.test_6_stationary_performance.__name__
        domain = libv()
        H = 5.0
        hubHt = 6.0
        D = 6.0
        ...
        plt.savefig('test_6_stationary_performance.png', dpi=150)
        plt.show()
